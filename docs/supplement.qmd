...
- **excluding gift packages** — food-package rows recorded as gifts from non-camp members removed (76 returns rows and 2 recall rows; 2.4% of returned kcal). The canonical fit retains these rows; this variant quantifies their influence, which is negligible — every estimand matches the canonical fit to two decimals;
...
SENSITIVITY_VARIANTS = {
    ...
    "sens_no_gifts": "excluding gift packages",
