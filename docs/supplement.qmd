...
- Effort observations. For each forager × in-camp date, an effort indicator is set to 1 if the forager logged positive time on an out-of-camp trip with activity type "Foraging" that day (or contributed to a returned food package), and 0 otherwise. Trips logged with a non-foraging purpose (22% of trips) do not count toward effort in the canonical fit; the all-outings sensitivity variant (§ Sensitivity Analyses) relaxes this. These observations enter the Bernoulli effort component.
...
### Why no hunting-only model

Reviewers of related work often ask whether skill curves differ for hunting specifically. In this dataset a hunting-only refit is not estimable: game accounts for just 4.0% of returned kcal (73 package rows across 32 days, touched by 26 foragers), far too sparse to identify a three-parameter learning-senescence curve plus individual random effects. The near-absence of hunting is itself informative — the age-related gains in production documented here arise almost entirely from gathered and collected resources, so they cannot be attributed to the long-delay proficiency profile that hunting-specific studies emphasize.
...
*Moved here from the main text at the reviewers' suggestion. Citation numbers
below follow the main-text reference list and need to be mapped to this
document's bibliography before submission.*

Compared to values reported in the main text, Kitanishi (49) finds approximately 1,000 fewer kcals per person per day returned to a forest camp between late August and early September 1992, which overlaps with the season covered in the present study (see also (29, 60, 61)). Kitanishi reports similar proportions of foraging returns attributed to wild tubers and wild nuts and seeds as in the present study. We report a smaller proportion of game and honey than Kitanishi, likely reflecting ecological shifts related to logging and overhunting (43, 62). In contrast, we found far greater returns for oil palm than Kitanishi. Oil palm is high in fat and carotenoids, precursors to vitamin A (65), and therefore likely nutritionally complements the plant-based proteinaceous foods (nuts and seeds, cassava leaves) harvested during the study period.

Higher daily returns in the present study are likely attributable to methodological, social, ecological, and seasonal factors. First, Kitanishi measured only food returned to camp, thus excluding harvests consumed during subsistence trips; nine percent of total production in the present study was consumed while on foraging trips (@fig-returns-vs-recall-pie). Second, we observed that in many cases participants with an excess of oil palm transported it to the village, two hours' walk from camp, to share with kin or with Bandongo fictive kin (66); not all food production was therefore consumed on site. While the study village is relatively remote and BaYaka do not engage directly in the sale of forest products (45), Bandongo do sometimes commission BaYaka to collect oil palm in order to sell it onwards to the logging town, in exchange for goods such as baby clothes, machetes, and radios. It is important to note, however, that the resources received through such exchanges often reflect acute fertility or subsistence needs, or shared joy — a foundational aspect of BaYaka social and spiritual life (67, 68) — and are often circulated as part of the immediate-return sharing economy and the acquisition of forest-spirit plays (69, 70). Third, the forest surrounding the camp is known regionally as being especially rich in oil palm, contrasting with Kitanishi's study location. Finally, during the research period participants were preparing for the *kombi* fishing season, which occurs in parts of the forest where oil palm is rare; small quantities of excess palm oil were likely stored for use in *kombi* camps.
