...
for _d in (returns_rr, recall_rr):
    _d.columns = [c.lower() for c in _d.columns]
returns_rr = returns_rr[pd.to_numeric(returns_rr["gift"], errors="coerce").fillna(0) != 1]
recall_rr = recall_rr[pd.to_numeric(recall_rr["gift"], errors="coerce").fillna(0) != 1]
