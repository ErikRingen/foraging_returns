...
![Per-forager Shapley-kcal share by resource, stratified by within-gender skill tercile. Two panels (males, females); each forager appears as a faint coloured line, tercile means in bold. High-skill foragers of both genders concentrate kcal in oil palm (41% of kcal for high-skill males, 32% for high-skill females); their remaining specialisation diverges by gender, towards honey for males (36%, vs. 3% for females) and *mela* wild yams for females (37%, vs. 4% for males). Low-skill foragers of both genders spread their returns across maondo, caterpillars, and cassava leaves.](../results/figures/eda_parallel_resource_skill.png){#fig-resource-by-skill fig-align="center" width="100%"}
